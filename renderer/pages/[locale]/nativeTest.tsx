...
const resolveGamepadKernel = (value: unknown): "web" | "node" => {
  const normalized = String(value || "").trim().toLowerCase();
  return normalized === "web" ? "web" : "node";
};
...
function NativeGamepadTesterPage() {
  ...
  const currentKernel = resolveGamepadKernel(settings?.gamepad_kernel);
          ...
          <CardBody className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div className="min-w-0">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Chip size="sm" variant="flat" color={currentKernel === "node" ? "success" : "warning"}>
